...
; DLL API библиотека: http://rebres.ru/AutoHotKey/Include SA-MP API AutoHotKey.rar
; Samp Dop Function: http://rebres.ru/AutoHotKey/SAMP-Dop-Function.ahk
; Библиотека dx9_overlay: http://rebres.ru/AutoHotKey/dx9_overlay for AHK.rar
...
; #    - getPlayerFps(float := false)               - Получить текущий FPS                                                      #
; # By ByNika                                                                                                                   #
